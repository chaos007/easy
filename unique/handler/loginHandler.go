...
func RegisterHandler(w http.ResponseWriter, r *http.Request) {
	...
	verify.GetVerifyMap().Add(a.UID, a.Cookie)
	result := &pb.WebDownRegister{
		UserID:      a.UID,
		Password:    password,
		Info:        down.Info,
...
// PlayerLoginToUnique 玩家通过agent登录
func PlayerLoginToUnique(sess *grpc.Session, data proto.Message) (proto.Message, error) {
	source, ok := data.(*pb.PlayerLoginToUnique)
	if !ok {
		return nil, nil
	}
